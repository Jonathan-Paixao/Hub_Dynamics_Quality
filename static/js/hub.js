...
// --- NOVA LÓGICA: ADMIN - GERENCIAR USUÁRIOS ---
    ...
    function addAdminAreaFilter(container) {
        ...
        select.className = 'admin-area-filter';
        select.innerHTML = '<option value="">Todas</option><option value="Spare Parts">Spare Parts</option><option value="Finished Goods">Finished Goods</option>';
        wrapper.appendChild(label);
        wrapper.appendChild(select);
        container.appendChild(wrapper);
        select.addEventListener('change', handleAdminSearch);
    }
    ...
    function addAdminRoleFilter(container) {
        ...
        select.className = 'admin-area-filter';
        select.innerHTML = '<option value="">Todas</option><option value="Analista">Analista</option><option value="Executor">Executor</option>';
        wrapper.appendChild(label);
        wrapper.appendChild(select);
        container.appendChild(wrapper);
        select.addEventListener('change', handleAdminSearch);
    ...
    function addAdminPlatformFilter(container) {
        ...
        const select = document.createElement('select');
        select.id = 'admin-platform-filter';
        select.className = 'admin-area-filter';
        select.innerHTML = '<option value="">Todas</option><option value="looker">Looker</option><option value="tableau">Tableau</option><option value="library">Library</option>';
        wrapper.appendChild(label);
        wrapper.appendChild(select);
        container.appendChild(wrapper);
        select.addEventListener('change', handleAdminSearch);
    ...
    function addAdminAutomationPlatformFilter(container) {
        ...
        select.id = 'admin-platform-filter';
        select.className = 'admin-area-filter';
        select.innerHTML = '<option value="">Todas</option><option value="sap">SAP</option><option value="bw">BW</option><option value="salesforce">Salesforce</option>';
        wrapper.appendChild(label);
        wrapper.appendChild(select);
        container.appendChild(wrapper);
        select.addEventListener('change', handleAdminSearch);
    ...
    function renderAdminAutomations() {
        ...
        keys.forEach((key, index) => {
            ...
            item.dataset.platform = (auto.type || '').toLowerCase();
